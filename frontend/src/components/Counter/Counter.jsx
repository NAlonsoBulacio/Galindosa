    ...
    <div className="w-full flex justify-center items-center py-12">
      <div className="flex flex-wrap justify-between items-center px-0 lg:px-10 notranslate">
        <div className="w-1/3 flex flex-wrap justify-start items-center">
          <div ref={ref1} className="w-full flex justify-center md:justify-center items-center">
            <p className="text-gray-600 poppins-bold text-center text-3xl md:text-5xl ">+{count1}</p>
          </div>
        ...
        <div className="h-full w-1/3 flex flex-wrap justify-center items-center text-center">
          <div ref={ref1} className="w-full h-2/3 flex justify-center md:justify-center items-center">
        ...
        <div className="w-1/3 flex flex-wrap justify-center items-center">
          <div ref={ref2} className="w-full flex justify-center md:justify-center items-center">
