...
const ContactForm = () => {
  ...
  return (
    <div className="form-container w-[400px] lg:w-[1300px] p-3 rounded-3xl shadow-lg mx-auto mt-8 max-w-lg relative ">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 bg-white rounded-b-3xl rounded-r-3xl py-6 px-6">
        <input
          type="text"
          name="nombre"
        ...
        <button type="submit" className="bg-[#ffc702] text-white p-4 rounded-3xl w-full poppins-regular">
