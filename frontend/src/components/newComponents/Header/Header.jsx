      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 text-left w-full h-96 px-4 mt-10 bg-gray-900 text-white poppins-semibold z-20 flex flex-col items-start justify-center space-y-4"
          >
