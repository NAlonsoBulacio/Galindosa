...
const newsData = [
  {
    image: 'https://grupoproaco.com/img/b231a9d5-96a5-4e6f-8ad0-3141d5fae076/Untitleddesign.jpg?q=80&fit=max&crop=5382%2C3588%2C0%2C0',
    category: 'PRENSA',
    title: 'Galindo S.A., en el top de los lugares más buscados para vivir en Córdoba',
    description: 'Según la última investigación de Clasificados La Voz, Galindo S.A. emerge como el principal destino para quienes buscan establecerse o invertir en la ciudad. Con más de 270 propiedades disponibles para venta o alquiler, esta moderna urbanización se coloca en la cima del ranking, consolidándose como el lugar preferido de los cordobeses para vivir y construir.',
    link: '#'
  },
  {
    image: 'https://grupoproaco.com/img/32f08eb9-586d-4848-b4be-9cd8948d2f43/avancesdeobra.jpg?q=80&fit=max&crop=1279%2C720%2C0%2C0',
    category: 'DESARROLLISMO',
    title: 'Galindo S.A. entregó la Estación Transformadora de energía eléctrica a EPEC',
    description: 'Galindo S.A. entregó la Estación Transformadora de energía eléctrica a EPEC.',
    link: '#'
  },
  {
    image: 'https://grupoproaco.com/img/ca00c522-47a0-4316-9eed-8301177decf6/avancesdeobra.jpg?q=80&fit=max&crop=1279%2C720%2C0%2C0',
    category: 'DESARROLLISMO',
    title: 'El Estudio ZAP presentó el Distrito Córdoba Shopping con Galindo S.A.',
    description: 'El Arquitecto Javier Zanotti (Estudio de Arquitectura ZAP) reveló DÚO, un nuevo proyecto inmobiliario integrado al primer gran centro comercial de la ciudad. Se trata de dos torres residenciales y un edificio corporativo, que se complementa con nuevos estacionamientos y que potenciará este tradicional sector de Córdoba. Como gran novedad, apuntará a la sustentabilidad, marcando el hito de ser las primeras torres del interior de Argentina con generación distribuida.',
    link: '#'
  }
];
