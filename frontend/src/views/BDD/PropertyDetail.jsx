...
const PropertyDetail = () => {
  ...
  const handleUploadToggle = (componentId) => {
    ...
    setActiveUploadComponent((prevComponentId) => (prevComponentId === componentId ? null : componentId))
  }
  ...
  const handleCheckboxChange = (e) => {
    ...
    if (name === "amenities") {
      const selectedAmenity = amenities.find((amenity) => amenity.id.toString() === value)
      ...
      const selectedAmbient = ambients.find((ambient) => ambient.id.toString() === value)
      ...
      setProperty((prevProperty) => ({
        ...prevProperty,
        [name]: checked ? [...prevProperty[name], value] : prevProperty[name].filter((item) => item !== value),
      }))
    }
  }
  ...
  const addSection = () => {
    setProperty((prevProperty) => ({
      ...prevProperty,
      sections: [...prevProperty.sections, { title: "", text: "", images: [], amenities: [] }],
    }))
  }
  ...
  const handleSectionImageChange = (img, index) => {
    setProperty((prevProperty) => {
      ...
      sections[index] = {
        ...sections[index],
        images: Array.isArray(img) ? img : [...(sections[index].images || []), img],
      }
      return { ...prevProperty, sections }
    })
  }
  ...
  const handleDeleteProperty = () => {
    ...
    if (confirmDelete) {
      ...
      axios
        .delete(`https://galindobackend-production.up.railway.app/properties/${property.id}`)
        .then((response) => {
        ...
        .catch((error) => {
          ...
          alert("Hubo un error al intentar eliminar la propiedad. Inténtalo de nuevo.")
        })
    }
  }
  if (!property) {
    ...
    <>
      <div className="px-32 py-10">
        <div className="w-full flex justify-between">
          ...
          <div>
            {isChanging ? (
              <button className="text-2xl mr-3 bg-blue-500 px-3 py-1 rounded-lg text-gray-200" onClick={handleReturn}>
                X
              </button>
            ) : (
              ""
            ...
            <div className="flex flex-col gap-10 justify-center">
              ...
              <div className="sm:col-span-3">
                      ...
                      <div className="flex justify-center mt-1 space-x-2">
                        ...
                        <button
                          ...
                          className={`p-1 border rounded ${
                            index === presentImages.length - 1 ? "opacity-50" : "hover:bg-gray-200"
                          }`}
                        >
                          <FaArrowRight />
                        </button>
                ...
                >
                  ...
                  <IoIosArrowDown
                    className={`${activeUploadComponent === "presentImages" ? "rotate-180" : ""} duration-300`}
                  />
                </div>
              ...
              {/* Campo de Ambientes */}
              <div className="sm:col-span-4">
                <label htmlFor="rooms" className="block text-sm font-bold leading-6 text-gray-900">
                  Ambientes
                </label>
                <div className="mt-2 grid grid-cols-2 gap-4">
                  {ambients.map((ambient) => (
                    <div key={ambient.id} className="flex items-center">
                      ...
                      <select
                        value={
                          property.rooms.find((room) => room.id === ambient.id)?.available ? "disponible" : "agotado"
                        }
              ...
              {/* Amenities */}
              <div className="sm:col-span-4">
                <label htmlFor="amenities" className="block text-sm font-bold leading-6 text-gray-900">
                  Amenidades
                </label>
                <div className="mt-2 grid grid-cols-2 gap-4">
              ...
              <div className="col-span-full">
                <h3 className="text-lg font-bold leading-6 text-gray-900">Secciones</h3>
                  ...
                  <div>
                    <div className="flex justify-center mt-1 space-x-2">
                      ...
                      <button
                        ...
                        className={`p-1 border rounded ${
                          index === localSections.length - 1 ? "opacity-50" : "hover:bg-gray-200"
                        }`}
                      >
                        <FaArrowDown />
                      </button>
